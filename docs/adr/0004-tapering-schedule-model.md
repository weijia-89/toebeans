...
|---|---|---|
| **S**poofing | N/A: calculator has no identity surface | n/a |
...
| **I**nformation disclosure | N/A: no secrets in dose data | n/a |
...
| **E**levation of privilege | N/A: calculator has no auth boundary | n/a |
