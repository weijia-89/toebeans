...
| ✓ | **Today dose row: Edit affordance + spacing** (PR #75). Edit beside Log dose; routes to `MedicationEditScreen`. **Medication edit context card** (pet name, med + dose, schedule hint) on edit/add screens (PR #75 follow-up). Unified modal remains M1.2 open row. | Operator product intent 2026-05-27 |
