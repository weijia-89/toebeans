...
| ✓ (PR [#52](https://github.com/weijia-89/toebeans/pull/52) open @ EOD) | `BootReceiver` + 72h-horizon SQLDelight rehydration in receiver process (`ToebeansApp.loadPendingRemindersInHorizon`, `rehydrateBootAlarms`). **Merge pending** on `main` as of 2026-05-26 EOD; APPROVE + merge gate PASS. | v0.1-followups #4 · SDK T4 |
